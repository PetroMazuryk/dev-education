export const tasksJS = [
  {
    ...
    title: "Проміс. Реалізуй функцію 'resolve' [ 55:20 ]",
    requirements: [
...
resolve([Promise.reject(5), Promise.reject(6)]).catch(console.log); // [5, 6]`,
  ...
  },
  {
    id: 2,
    link: 'https://www.youtube.com/watch?v=OZPOO79Y4jk&t=4503s',
    title: "Проміс. Реалізуй функцію 'resolve': Варіант 2 ",
    requirements: [
...
resolve([Promise.reject(5), Promise.reject(6)]).catch(console.log); // [5, 6]`,
  },
  {
    id: 3,
    link: 'https://www.youtube.com/watch?v=OZPOO79Y4jk&t=4503s',
    title: "Проміс. Реалізуй функцію 'resolve': Варіант 3 ",
    requirements: [
      'Функція приймає масив значень або Promise.,',
      'Функція повинна повертати новий Promise.',
      '📌 Логіка роботи:',
      '✅ Якщо хоча б один проміс виконався успішно,',
      'функція повинна: завершитися зі статусом resolve',
      'повернути масив усіх успішних результатів.',
      '❌ Якщо всі проміси завершилися з помилкою,',
      'функція повинна: завершитися зі статусом reject',
      'повернути масив усіх помилок (з урахуванням їхніх індексів).',
    ],
...
// [7, 8, 9]`,
  ...
  },
  {
    id: 4,
    link: 'https://www.youtube.com/watch?v=OZPOO79Y4jk&t=4503s',
    title: 'Групування. Дано масив цілих натуральних чисел [ 1:07:00 ]',
    requirements: [
...
у групу по одному.`,
  },
  {
    id: 5,
    link: '',
    title: 'Групування. Дано масив цілих натуральних чисел ',
    requirements: [
