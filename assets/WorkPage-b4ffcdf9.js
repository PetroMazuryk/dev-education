...
Напрям дисплея підбирай відповідно до монтажу на щитку`},{id:100,link:"",title:"",requirements:[" "],starterCode:"",solution:"",description:""},{id:1400,link:"",title:"",requirements:[" "],starterCode:"",solution:"",description:""}],S=[{id:1,link:"",title:"SA-24 стирання історії (файлу)]",requirements:[" Клавіатура / Win / my Computer / Transed / Batch / ","вибираємо місяць / компонент / delete"],starterCode:"",solution:"",description:""}],x="_title_f5mrh_1",h={title:x},l={work_SA24:D,maint:E,screen:S},j=()=>{const[t,r]=a.useState(Object.keys(l)[0]),n=s=>{r(s.target.value)},i=t?l[t]:[];return e.jsxs("main",{style:{padding:"4px"},children:[e.jsx("h2",{className:h.title,children:"Робочі записи"}),e.jsx(m,{value:t,onChange:n,options:Object.keys(l)}),i.length===0&&t&&e.jsx("p",{children:"Немає записів для цього підрозділу."}),i.map(s=>e.jsx(c,{task:s},s.id))]})};export{j as default};
