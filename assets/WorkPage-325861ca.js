import{r as l,j as t}from"./index-3a575f4b.js";import{L as d}from"./LessonBlock-546ded9d.js";const a=[{id:1,link:"",title:"SA-24 Світловий потік з чашками 2 кам / 3 кам: ",requirements:[" "],starterCode:`1 мл, 2 мл -  50 000 / 70 000 Lux
...
Напрям дисплея підбирай відповідно до монтажу на щитку`},{id:100,link:"",title:"",requirements:[" "],starterCode:"",solution:"",description:""},{id:1400,link:"",title:"",requirements:[" "],starterCode:"",solution:"",description:""}],u="_title_f5mrh_1",p={title:u},r={work_SA24:a,maint:c},S=()=>{const[i,n]=l.useState(""),o=e=>{n(e.target.value)},s=i?r[i]:[];return t.jsxs("main",{style:{padding:"4px"},children:[t.jsx("h2",{className:p.title,children:"Робочі записи"}),t.jsxs("label",{children:["Оберіть підрозділ:",t.jsxs("select",{value:i,onChange:o,children:[t.jsx("option",{value:"",children:"Виберіть підрозділ:"}),Object.keys(r).map(e=>t.jsx("option",{value:e,children:e},e))]})]}),s.length===0&&i&&t.jsx("p",{children:"Немає записів для цього підрозділу"}),s.map(e=>t.jsx(d,{task:e},e.id))]})};export{S as default};
