import{j as e,r as l}from"./index-406620d1.js";import{L as a}from"./LessonBlock-7e1ea68b.js";const d=({value:t,onChange:r,options:n})=>e.jsxs("label",{children:["Оберіть підрозділ:",e.jsxs("select",{value:t,onChange:r,children:[e.jsx("option",{value:"",children:"Виберіть підрозділ:"}),n.map(i=>e.jsx("option",{value:i,children:i},i))]})]}),c=[{id:1,link:"",title:"SA-24 Світловий потік з чашками 2 кам / 3 кам: ",requirements:[" "],starterCode:`1 мл, 2 мл -  50 000 / 70 000 Lux
...
Напрям дисплея підбирай відповідно до монтажу на щитку`},{id:100,link:"",title:"",requirements:[" "],starterCode:"",solution:"",description:""},{id:1400,link:"",title:"",requirements:[" "],starterCode:"",solution:"",description:""}],p="_title_f5mrh_1",D={title:p},o={work_SA24:c,maint:u},m=()=>{const[t,r]=l.useState(""),n=s=>{r(s.target.value)},i=t?o[t]:[];return e.jsxs("main",{style:{padding:"4px"},children:[e.jsx("h2",{className:D.title,children:"Робочі записи"}),e.jsx(d,{value:t,onChange:n,options:Object.keys(o)}),i.length===0&&t&&e.jsx("p",{children:"Немає записів для цього підрозділу"}),i.map(s=>e.jsx(a,{task:s},s.id))]})};export{m as default};
