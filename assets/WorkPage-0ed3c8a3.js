import{j as e,r as a}from"./index-127327de.js";import{L as c}from"./LessonBlock-f4966bd0.js";const d="_wrapper_1jwtr_1",p="_label_1jwtr_18",u="_select_1jwtr_26",o={wrapper:d,label:p,select:u},D=({value:t,onChange:r,options:n})=>e.jsxs("div",{className:o.wrapper,children:[e.jsx("label",{className:o.label,children:"Оберіть підрозділ:"}),e.jsxs("select",{className:o.select,value:t,onChange:r,children:[e.jsx("option",{value:"",children:"Виберіть підрозділ:"}),n.map(i=>e.jsx("option",{value:i,children:i},i))]})]}),E=[{id:1,link:"",title:"SA-24 Світловий потік з чашками 2 кам / 3 кам: ",requirements:[" "],starterCode:`1 мл, 2 мл -  50 000 / 70 000 Lux
...
Напрям дисплея підбирай відповідно до монтажу на щитку`},{id:100,link:"",title:"",requirements:[" "],starterCode:"",solution:"",description:""},{id:1400,link:"",title:"",requirements:[" "],starterCode:"",solution:"",description:""}],S="_title_f5mrh_1",x={title:S},l={work_SA24:E,maint:m},O=()=>{const[t,r]=a.useState(Object.keys(l)[0]),n=s=>{r(s.target.value)},i=t?l[t]:[];return e.jsxs("main",{style:{padding:"4px"},children:[e.jsx("h2",{className:x.title,children:"Робочі записи"}),e.jsx(D,{value:t,onChange:n,options:Object.keys(l)}),i.length===0&&t&&e.jsx("p",{children:"Немає записів для цього підрозділу"}),i.map(s=>e.jsx(c,{task:s},s.id))]})};export{O as default};
