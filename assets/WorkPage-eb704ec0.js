...
Напрям дисплея підбирай відповідно до монтажу на щитку`},{id:100,link:"",title:"",requirements:[" "],starterCode:"",solution:"",description:""},{id:1400,link:"",title:"",requirements:[" "],starterCode:"",solution:"",description:""}],S="_title_f5mrh_1",x={title:S},l={work_SA24:E,maint:m},O=()=>{const[t,r]=a.useState(""),n=s=>{r(s.target.value)},i=t?l[t]:[];return e.jsxs("main",{style:{padding:"4px"},children:[e.jsx("h2",{className:x.title,children:"Робочі записи"}),e.jsx(D,{value:t,onChange:n,options:Object.keys(l)}),i.length===0&&t&&e.jsx("p",{children:"Немає записів для цього підрозділу"}),i.map(s=>e.jsx(c,{task:s},s.id))]})};export{O as default};
