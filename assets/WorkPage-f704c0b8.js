...
1 кам – 4000 Lux
4 кам - 6000 Lux
`,solution:"",description:""},{id:3,link:"",title:"Test set - на початку зміни та через 20 годин. 5- разів",requirements:[" "],starterCode:`Без пригарів  5 добрі / 9 погані,
З пригарами 5 добрі / 11 погані,
перевірка на колірність плюс 1 ам №15,
Тест на рівень 10/20   - 1 раз`,solution:"",description:""},{id:4,link:"",title:"",requirements:[" "],starterCode:"",solution:"",description:""}],s="_title_f5mrh_1",o={title:s},d=()=>i.jsxs("main",{style:{padding:"4px"},children:[i.jsx("h2",{className:o.title,children:"Робочі записи"}),r.map(t=>i.jsx(e,{task:t},t.id))]});export{d as default};
