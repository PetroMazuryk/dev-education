...
console.log(sum); //26`,description:""},{id:124,link:"",title:" ",requirements:["Створення "],starterCode:"",solution:"",description:""},{id:126,link:"",title:" ",requirements:["Створення "],starterCode:"",solution:"",description:""},{id:128,link:"",title:" ",requirements:["Створення "],starterCode:"",solution:"",description:""}],d="_title_f5mrh_1",g={title:d},r={tasksJS:m},f=()=>{const[o,i]=c.useState(Object.keys(r)[0]),s=e=>{i(e.target.value)},n=o?r[o]:[];return t.jsxs("main",{style:{padding:"4px"},children:[t.jsx("h2",{className:g.title,children:"Задачі JS"}),t.jsx(a,{value:o,onChange:s,options:Object.keys(r)}),n.length===0&&o&&t.jsx("p",{children:"Немає задач для цієї категорії."}),n.sort((e,l)=>e.id-l.id).map(e=>t.jsx(u,{task:e},e.id))]})};export{f as default};
