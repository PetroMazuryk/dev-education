...
1 кам – 4000 Lux
4 кам - 6000 Lux
`,solution:"",description:""},{id:3,link:"",title:"",requirements:[" "],starterCode:"",solution:"",description:""}],o="_title_f5mrh_1",s={title:o},E=()=>i.jsxs("main",{style:{padding:"4px"},children:[i.jsx("h2",{className:s.title,children:"Робочі записи"}),r.map(t=>i.jsx(e,{task:t},t.id))]});export{E as default};
