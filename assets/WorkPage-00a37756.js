...
Напрям дисплея підбирай відповідно до монтажу на щитку`},{id:2,link:"",title:"SA-24 Світловий потік з чашками 2 кам / 3 кам: ",requirements:[" "],starterCode:`1 мл, 2 мл -  50 000 / 70 000 Lux
5 мл – 70 000 / 95 000 Lux
10 мл -  100 000 / 130 000 Lux
без чашок > 200 000 Lux
1 кам – 4000 Lux
4 кам - 6000 Lux
`,solution:"",description:""},{id:3,link:"",title:"SA-24. Test set 5 разів - на початку зміни та через 20 годин. ",requirements:[" "],starterCode:`Без пригарів  5 добрі / 9 погані,
З пригарами 5 добрі / 11 погані,
перевірка на колірність плюс 1 ам №15,
Тест на рівень 10/20   - 1 раз`,solution:"",description:""},{id:4,link:"",title:" SA-24 Штативи (ROTA) ",requirements:[" "],starterCode:`1 мл , 2мл – 1200 шт
5 мл - 440 шт
10 мл - 360 шт `,solution:"",description:""},{id:1400,link:"",title:"",requirements:[" "],starterCode:"",solution:"",description:""}],c=[{id:100,link:"",title:"",requirements:[" "],starterCode:"",solution:"",description:""},{id:1400,link:"",title:"",requirements:[" "],starterCode:"",solution:"",description:""}],u="_title_f5mrh_1",p={title:u},r={WORK:a,MAINT:c},S=()=>{const[i,n]=l.useState(""),o=e=>{n(e.target.value)},s=i?r[i]:[];return t.jsxs("main",{style:{padding:"4px"},children:[t.jsx("h2",{className:p.title,children:"Робочі записи"}),t.jsxs("label",{children:["Оберіть підрозділ:",t.jsxs("select",{value:i,onChange:o,children:[t.jsx("option",{value:"",children:"Виберіть підрозділ:"}),Object.keys(r).map(e=>t.jsx("option",{value:e,children:e},e))]})]}),s.length===0&&i&&t.jsx("p",{children:"Немає записів для цього підрозділу"}),s.map(e=>t.jsx(d,{task:e},e.id))]})};export{S as default};
